...
namespace CYM.Line
{
    ...
    public class BaseGLineMgr : BaseGFlowMgr
    {
        ...
        protected BaseObjectPool<FastLineRenderer> LinePool;
        ...
        {
            base.OnUpdate();
            if (BaseCameraMgr != null && BattleMgr.IsInBattle)
            {
        ...
        protected override void OnAllLoadEnd2()
        {
            ...
            if (ResourceObj != null)
            {
                ...
                LinePool = new BaseObjectPool<FastLineRenderer>(CreateLineRender);
            }
        ...
        protected override void OnBattleUnLoad()
        {
            ...
            while (LinePool.CountInPool > 0)
            {
                var r = LinePool.GetInPool();
