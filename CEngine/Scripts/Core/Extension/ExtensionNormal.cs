...
namespace CYM
{
    public static class ExtensionNormal
    {
        ...
        public static string GetCont(this string str, params object[] param)
        {
            return BaseLangMgr.Get(SysConst.Prefix_Cont + str, param);
        }
        ...
        #region Rand       
        public static T Rand<T>(this IList array) where T:class
        {
            if (array == null) return default;
            if (array.Count <= 0) return default;
            return array[RandUtil.RangeArray(array.Count)] as T;
        }
