...
namespace CYM
{
    ...
    public partial class UIUtil
    {
        ...
        public static Anchor GetAnchor(RectTransform rectTrans)
        {
            if (rectTrans.anchorMin == new Vector2(0.5f, 0) && rectTrans.anchorMax == new Vector2(0.5f, 0)) return Anchor.Bottom;
            else if (rectTrans.anchorMin == new Vector2(0.0f, 0) && rectTrans.anchorMax == new Vector2(0.0f, 0)) return Anchor.BottomLeft;
            else if (rectTrans.anchorMin == new Vector2(1.0f, 0) && rectTrans.anchorMax == new Vector2(1.0f, 0)) return Anchor.BottomRight;
            else if (rectTrans.anchorMin == new Vector2(0.0f, 0.5f) && rectTrans.anchorMax == new Vector2(0.0f, 0.5f)) return Anchor.Left;
            else if (rectTrans.anchorMin == new Vector2(1.0f, 0.5f) && rectTrans.anchorMax == new Vector2(1.0f, 0.5f)) return Anchor.Right;
            else if (rectTrans.anchorMin == new Vector2(0.5f, 1.0f) && rectTrans.anchorMax == new Vector2(0.5f, 1.0f)) return Anchor.Top;
            else if (rectTrans.anchorMin == new Vector2(0.0f, 1.0f) && rectTrans.anchorMax == new Vector2(0.0f, 1.0f)) return Anchor.TopLeft;
            else if (rectTrans.anchorMin == new Vector2(1.0f, 1.0f) && rectTrans.anchorMax == new Vector2(1.0f, 1.0f)) return Anchor.TopRight;
            return Anchor.None;
        }
        public static void SetAnchorPosition(RectTransform rectTrans, Anchor anchor, Vector2 pos)
        {
            ...
            {
                rectTrans.pivot = new Vector2(0.5f, 0.0f);
