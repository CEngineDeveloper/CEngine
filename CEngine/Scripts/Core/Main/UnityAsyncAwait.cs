...
namespace CYM
{
    ...
    public static class IEnumeratorAwaitExtensions
    {
        ...
        public static SimpleCoroutineAwaiter<UnityEngine.Object> GetAwaiter(this ResourceRequest instruction)
        {
            ...
            RunOnUnityScheduler(() => UnityAsyncAwait.Instance.StartCoroutine(
    ...
    public class UnityAsyncAwait : MonoBehaviour
    {
        static UnityAsyncAwait _instance;

        public static UnityAsyncAwait Instance
        {
            get
            {
                if (_instance == null)
