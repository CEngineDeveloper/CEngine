...
namespace CYM.Audio
{
    ...
    public partial class SoundManager : MonoSingleton<SoundManager>
    {
        ...
        public static void RemoveSoundConnectionForLevel(string lvl)
        {
            ...
            {
                Ins.soundConnections.RemoveAt(_indexOf);
            }
        }
        ...
        {
            return Ins.soundConnections.FindIndex(
        ...
        public static SoundConnection GetSoundConnectionForThisLevel(string lvl)
        {
            ...
            if (index == SOUNDMANAGER_FALSE)
                return null;
            return Ins.soundConnections[index];
        }
        ...
        {
            return MuteMusic(!Ins.mutedMusic);
        }
        ...
        {
            Ins.mutedMusic = toggle;
            return Ins.mutedMusic;
        }

        /// <summary>
        /// Determines whether this Ins is music muted.
        /// </summary>
        /// <returns>
        /// <c>true</c> if this Ins is music muted; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Determines whether this Ins is muted.
        /// </summary>
        /// <returns>
        ...
        public static void SetVolumeMusic(float setVolume)
        {
            ...
            currentPercentageOfVolume1 = Ins.volume1 / Ins.maxMusicVolume;
            currentPercentageOfVolume2 = Ins.volume2 / Ins.maxMusicVolume;

            Ins.maxMusicVolume = setVolume * Ins.maxVolume;

            if (float.IsNaN(currentPercentageOfVolume1) || float.IsInfinity(currentPercentageOfVolume1))
                if (Ins.audios[0].isPlaying)
            ...
            if (float.IsNaN(currentPercentageOfVolume2) || float.IsInfinity(currentPercentageOfVolume2))
                if (Ins.audios[1].isPlaying)
                    currentPercentageOfVolume2 = 1f;
                else
                    currentPercentageOfVolume2 = 0f;

            Ins.volume1 = Ins.maxMusicVolume * currentPercentageOfVolume1;
            Ins.volume2 = Ins.maxMusicVolume * currentPercentageOfVolume2;
        }
        ...
        {
            Ins.audios[0].pitch = Ins.audios[1].pitch = setPitch;
        }
        ...
        public static void SetVolume(float setVolume)
        {
            ...
            currentPercentageOfVolumeMusic = Ins.maxMusicVolume / Ins.maxVolume;
            currentPercentageOfVolumeSFX = Ins.maxSFXVolume / Ins.maxVolume;

            Ins.maxVolume = setVolume;
        ...
        {
            return Ins.currentSoundConnection;
        }
        ...
        {
            Ins.currentSoundConnection = connection;
        }
        ...
        {
            Ins._PlayImmediately(clip2play, loop, runOnEndFunction);
        }
        ...
        {
            if (Ins.currentSoundConnection == null)
                return null;
            return Ins.currentSoundConnection.soundsToPlay;
        }
        ...
        public static bool ClipNameIsValid(string clipName)
        {
            ...
            return Ins.allClips.ContainsKey(clipName) && Ins.allClips[clipName] != null;
        }
        ...
        public static bool GroupNameIsValid(string groupName)
        {
            ...
            return Ins.groups.ContainsKey(groupName) && Ins.groups[groupName] != null;
        }
        ...
        {
            return Ins.IsPlaying(GetCurrentSong());
        }
