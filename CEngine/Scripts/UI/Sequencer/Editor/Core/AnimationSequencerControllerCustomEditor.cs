...
namespace CYM.UI.Sequencer
{
    ...
    public class AnimationSequencerControllerCustomEditor : Editor
    {
        ...
        private void OnClickToRemove(ReorderableList list)
        {
            ...
            ExtensionSerializedProperty.ClearPropertyCache(element.propertyPath);
        ...
        {
            ExtensionSerializedProperty.ClearPropertyCache(list.serializedProperty.propertyPath);
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawFoldoutArea("Animation", ref showSettingsPanel, DrawSettings);
            DrawFoldoutArea("Callback", ref showCallbacksPanel, DrawCallbacks);
            DrawFoldoutArea("Sequence", ref showSequenceSettingsPanel, DrawSequenceSettings);
        }
