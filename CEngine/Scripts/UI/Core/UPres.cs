...
namespace CYM.UI
{
    public class UData
    {
        ...
        //触发
        [HideInInspector] public Callback<UControl, PointerEventData> OnEnter;
        [HideInInspector] public Callback<UControl, PointerEventData> OnExit;
        [HideInInspector] public Callback<UControl, PointerEventData> OnClick;
        [HideInInspector] public Callback<UControl, PointerEventData> OnTempClick; //用于替换原生的Click事件
        [HideInInspector] public Callback<UControl, PointerEventData> OnDelayClick;
        [HideInInspector] public Callback<UControl, PointerEventData> OnPlotClick;
        [HideInInspector] public Callback<UControl, PointerEventData> OnDown;
        [HideInInspector] public Callback<UControl, PointerEventData> OnUp;
        [HideInInspector] public Callback<UControl, PointerEventData> OnLongPress;
        [HideInInspector] public Callback<UControl, PointerEventData> OnLongEnter;
        [HideInInspector] public Callback<UControl, bool> OnInteractable;
        [HideInInspector] public Callback<UControl, bool> OnSelected;
        [HideInInspector] public Callback<UControl, bool> OnShow;
        [HideInInspector] public Callback<UControl, bool> OnShowActive;
        [HideInInspector] public Callback<UControl> OnRefresh;
        //拖拽
        [HideInInspector] public Callback<UControl, PointerEventData> OnBeginDrag;
        [HideInInspector] public Callback<UControl, PointerEventData> OnEndDrag;
        [HideInInspector] public Callback<UControl, PointerEventData> OnDrag;
        //判断
        [HideInInspector] public Func<int, bool> IsInteractable = null;
        [HideInInspector] public Func<int, bool> IsSelected = null;
        [HideInInspector] public Func<int, bool> IsCanClick = null;
        [HideInInspector] public Func<int, bool> IsShow = null;
