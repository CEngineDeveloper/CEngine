...
namespace CYM.UI
{
    public class UTextData : UData
    {
        ...
        #region 函数
        [HideInInspector] public Func<Sprite> Icon = null;
        [HideInInspector] public Func<Sprite> Bg = null;
        [HideInInspector] public Func<string> Name = null;
        [HideInInspector] public Func<TDBaseData> Rename = null;
        [HideInInspector] public Func<Color> Color = null;
        #endregion
