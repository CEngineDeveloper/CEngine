...
namespace CYM.Pool
{
    ...
    public static class PoolManager
    {
        ...
        public static SpawnPool Create(string name)
        {
            return Pools.Create(name);
        }
    ...
    {
        static GameObject PoolGameObj = new GameObject("Pool");

        public SpawnPoolsDict() : base()
        {
            GameObject.DontDestroyOnLoad(PoolGameObj);
        }
        ...
        public SpawnPool Create(string poolName)
        {
            ...
            owner.transform.SetParent(PoolGameObj.transform);
        ...
        internal void Add(SpawnPool spawnPool)
        {
            ...
            CLog.Log(string.Format("Added pool '{0}'", spawnPool.poolName));
