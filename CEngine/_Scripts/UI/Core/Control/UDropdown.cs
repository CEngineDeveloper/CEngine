    ...
    public class UDropdown : UPres<UDropdownData>
    {
        ...
        protected override void OnValidate()
        {
            ...
            if (tempCom)
            {
                ...
                ITemplate = tempCom.template;
                ICaptionText = tempCom.captionText;
                ICaptionImage = tempCom.captionImage;
                IItemText = tempCom.itemText;
                IItemImage = tempCom.itemImage;
            }
        }
#endif
        ...
        protected override void Awake()
        {
            ...
            if (Com)
            {
                Com.template = ITemplate;
                Com.captionText = ICaptionText;
                Com.captionImage = ICaptionImage;
                Com.itemText = IItemText;
                Com.itemImage = IItemImage;
