...
namespace CYM
{
    public partial class SysConst
    {
        ...
        //CYMUni
        public static readonly string Dir_CYMUni = "CYMUni";
        //Resources
        ...
        //CYMUni
        public static readonly string Path_CYMUni = Path.Combine(Application.dataPath, Dir_CYMUni);
        //Resources
        ...
        public static readonly string Path_TemplateConfig = Path.Combine(Path_CYMUni, "_Res/Configs/TemplateFiles");
        #endregion

        #region 工程目录的相对路径
        public static readonly string RPath_Assets = "Assets/";
        public static readonly string RPath_Uni = "Assets/Plugins/CEngine/";
        ...
        public static readonly string RPath_InternalBundle = Path.Combine(RPath_Uni, Dir_Bundles);
        public static readonly string RPath_Dlc = Path.Combine(RPath_Assets, Dir_Dlc);
        public static readonly string RPath_TempCYMMonobehaviour = Path.Combine(RPath_Uni, "_Res/Configs/TemplateFiles/CYMMonobehaviour.asset");
        public static readonly string RPath_TempMonobehaviour = Path.Combine(RPath_Uni, "_Res/Configs/TemplateFiles/Monobehaviour.asset");
        public static readonly string RPath_TempCSharp = Path.Combine(RPath_Uni, "_Res/Configs/TemplateFiles/CSharp.asset");
        #endregion
