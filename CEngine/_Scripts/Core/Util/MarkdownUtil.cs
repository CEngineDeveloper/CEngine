namespace CYM
{
    public partial class MarkdownUtil
    {
        ...
        // TODO: support for reference links
        ...
        {
            return Header(text, HeaderLevel.H1);
        }
        ...
        {
            return _LINK_INLINE_PRE + text + _LINK_INLINE_MID + url + _LINK_INLINE_END;
        }
        ...
        {
            return _IMG_INLINE_PRE + alt + _IMG_INLINE_MID + url + _IMG_INLINE_END;
        }
        ...
        {
            return _CODE_INLINE + text + _CODE_INLINE;
        }
        ...
        {
            return _CODE_BLOCK + language + _ENDL + text + _ENDL + _CODE_BLOCK;
        }
