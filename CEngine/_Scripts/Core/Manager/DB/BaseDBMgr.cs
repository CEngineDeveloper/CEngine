...
namespace CYM
{
        ...
        where TGameData : DBBaseGame, new()
    {
        ...
        protected DBData Convert<TData,DBData>(TData tdata,Callback<TData, DBData> callback=null) 
        ...
        protected virtual TGameData OnGenerateNewGameData()
        {
            ...
            data.PlayerID = BaseGlobal.ScreenMgr.SelectedChara;
        ...
        protected virtual void OnReadGameData(TGameData data)
        {
            ...
            BaseGlobal.ScreenMgr.SelectChara(data.PlayerID);
        }
        ...
        protected virtual void OnWriteGameData(ref TGameData data)
        {
            ...
            data.PlayerID = BaseGlobal.Player.TDID;
        }
