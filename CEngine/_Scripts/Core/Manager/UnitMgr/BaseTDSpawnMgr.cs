...
namespace CYM
{
        ...
        where TData : TDBaseData, new()
    {
        ...
        //游戏开始的时候创建一个新的对象
        public virtual TData SpawnNew(string tdid, [DefaultValue("UnitSpawnParam.Default")] UnitSpawnParam param)
        {
        ...
        //创建对象
        public virtual TData Spawn(string tdid, [DefaultValue("UnitSpawnParam.Default")] UnitSpawnParam param)
        {
        ...
        public virtual void OnSpawned(TData unit, [DefaultValue("UnitSpawnParam.Default")] UnitSpawnParam param) { }
