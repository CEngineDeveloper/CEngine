...
namespace CYM.DLC
{
    ...
    public class DLCItem
    {
        ...
        //const 路径
        public string ConstPath { get; private set; }
        #endregion
        ...
        public List<BuildRuleConfig> BuildRuleData { get; protected set; } = new List<BuildRuleConfig>();
        ...
        public DLCItem(DLCItemConfig config, AssetBundleManifest assetBundleManifest=null)
        {
            ...
            //计算Const路径
            ConstPath = Path.Combine(SysConst.RPath_Resources, SysConst.Dir_Const, Name + "Const.cs");
            //计算Manifest路径
        ...
        public string GetConst() => ConstPath;
        #endregion
        ...
        private string CalcAssetRootPath(string dlcName)
        {
            if (IsEditorMode)
            {
